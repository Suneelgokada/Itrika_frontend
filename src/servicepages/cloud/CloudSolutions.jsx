  ...
  return (
    <div className="bg-slate-50 text-slate-800">
      ...
      <section className="border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-2 md:grid-cols-4 gap-10 text-center">
          <Metric value={`${years}+`} label="Years Experience" />
          <Metric value={`${deployments}+`} label="Cloud Deployments" />
          <Metric value={`${uptime}%`} label="Uptime SLA" />
          <Metric value={`${support}/7`} label="Support Coverage" />
        </div>
      </section>
